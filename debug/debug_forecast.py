...
df_param = pd.read_csv(
    "/home/leon/Doc/programm/SDG/hera/fcst_local/param.csv"
...
today = datetime.datetime.strptime("2023-01-17", "%Y-%m-%d").date()
...
df = df[df["giorno_gas"] <= today + timedelta(days=5)]
...
forecast_udf = forecast_udf_gen(
    ...
    models_config={
        "pmdarima_1": {"model_flavor": "pmdarima", "m": 7, "seasonal": True}
    },
