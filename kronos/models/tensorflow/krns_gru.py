...
class KRNSGRU:
    """
    Class to implement GRU in kronos.
    """
    ...
    def __init__(
        ...
        :param tf.keras.Sequential: An already fitted Sequential model containing a GRU layer, to instantiate a kronos GRU from an already fitted model.
        :param int n_units: Number of units in the GRU layer of the model.
        :param str activation: Activation function in the GRU layer of the model.
        ...
        try:
            ...
            self.model = tf.keras.Sequential(
                [
                    ...
                    tf.keras.layers.GRU(units=self.n_units, activation=self.activation),
