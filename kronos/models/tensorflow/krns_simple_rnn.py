...
class KRNSSimpleRNN:
    """
    Class to implement SimpleRNN in kronos.
    """
    ...
    def __init__(
        ...
        :param tf.keras.Sequential: An already fitted Sequential model containing a SimpleRNN layer, to instantiate a kronos SimpleRNN from an already fitted model.
        :param int n_units: Number of units in the SimpleRNN layer of the model.
        :param str activation: Activation function in the SimpleRNN layer of the model.
